...
def get_eval_spec():
    ...
    return {"transform": transform, "batchsize": 8}
...
def before_epoch(train_history, validation_history):
    ...
    if len(validation_history) >= 1:
        val_acc, val_loss = validation_history[-1]
...
def before_batch(train_history, validation_history):
    ...
    """
    return {"optimizer": {"lr": 0.01}, "batch_norm": None, "drop_out": 0.2}
